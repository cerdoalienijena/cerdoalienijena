...
public class Proyecto_depurado {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.print("Elija su opción:\n"
                    ...
                    + "6. Resto de una división entera \n"
                    + "7. Salir \n");
            ...
            System.out.println("\n¿Quiere intentarlo de nuevo? " + Usuario);
            System.out.println("Presione S para salir u otra tecla para continuar");
        ...
        switch (dificultad) {// EN ESTE SWITCH DEPENDIENDO EN QUE CURSO ESTE EL USUARIO ASIGNAMOS LA DIFICULTAD
            case 1:
                ...
                do {
                    ...
                    while (respuesta != suma && countdownStarter >= 1) {
        ...
        switch (dificultad) {// EN ESTE SWITCH DEPENDIENDO EN QUE CURSO ESTE EL USUARIO ASIGNAMOS LA DIFICULTAD
            case 1:
                ...
                do {
                    ...
                    System.out.println("Cual es la respuesta");
                    respuesta = sc3.nextInt();
                    if (respuesta == resta && countdownStarter > 0) {
                        System.out.println("Es correcto");
                        count++;
//Si es correcta la respuesta sumamso 1 en el contador de preguntas correctas
                    }
                    while (respuesta != resta && countdownStarter >= 1) {
                        System.out.println("Es incorrecto prueba otra vez");
                        System.out.println("Cual es la respuesta");
                        respuesta = sc3.nextInt();
                        if (respuesta == resta && countdownStarter > 0) {
        ...
        switch (dificultad) {// EN ESTE SWITCH DEPENDIENDO EN QUE CURSO ESTE EL USUARIO ASIGNAMOS LA DIFICULTAD
            case 1:
                ...
                do {
                    ...
                    System.out.println("Cual es la respuesta");
                    respuesta = sc3.nextInt();
                    if (respuesta == multiplicacion && countdownStarter > 0) {
                        System.out.println("Es correcto");
                        count++;
//Si es correcta la respuesta sumamso 1 en el contador de preguntas correctas
                    }
                    while (respuesta != multiplicacion && countdownStarter >= 1) {
                        System.out.println("Es incorrecto prueba otra vez");
                        System.out.println("Cual es la respuesta");
                        respuesta = sc3.nextInt();
                        if (respuesta == multiplicacion && countdownStarter > 0) {
        ...
        switch (dificultad) {
            case 1:
                ...
                do {
                    ...
                    System.out.println("Cual es la respuesta");
                    respuesta = sc3.nextInt();
                    if (respuesta == division && countdownStarter > 0) {
                        System.out.println("Es correcto");
                        count++;
//Si es correcta la respuesta sumamos 1 en el contador de preguntas correctas
                    }
                    while (respuesta != division && countdownStarter >= 1) {
                        System.out.println("Es incorrecto prueba otra vez");
                        System.out.println("Cual es la respuesta");
                        respuesta = sc3.nextInt();
                        if (respuesta == division && countdownStarter > 0) {
                    ...
                    preguntas++;
                    //cada vez que hay un ciclo del programa contamos 1 para saber cuantas preguntas hemos preguntado
                } while (preguntas != 10);
                countdownStarter = 0;
                System.out.println("Tu puntuacion es " + count + " sobre " + preguntas);
                return count;
        ...
        switch (dificultad) {
            case 1:
                ...
                do {
                    ...
                    System.out.println("Cual es la respuesta");
                    respuesta = sc3.nextInt();
                    if (respuesta == result && countdownStarter > 0) {
                        System.out.println("Es correcto");
                        count++;
//Si es correcta la respuesta sumamso 1 en el contador de preguntas correctas
                    }
                    while (respuesta != result && countdownStarter >= 1) {
                        System.out.println("Es incorrecto prueba otra vez");
                        System.out.println("Cual es la respuesta");
                        respuesta = sc3.nextInt();
                        if (respuesta == result && countdownStarter > 0) {
    ...
    /**
     * Temporizador usado en los metodos de calculo mental, este contará desde
     * 10 hasta 1, en la mayoría de las operaciones, en todos la cuenta es de 1
